import { l as r } from "../../Link-OoiLAnWb.js";
import { D as a, p as c } from "../../util-D2mgkBnY.js";
...
`;
var H = "sh-1d1c39w0", g = "sh-1d1c39w1", v = "sh-1d1c39w2", m = "sh-1d1c39w3";
const o = "text", s = {
  text: C,
  password: p,
  date: e,
...
class f extends HTMLElement {
  ...
  connectedCallback() {
    this.input = this.buildInput(), this.classList.add(H);
    ...
    c(this.input, this, [
      ...
      "name",
      "required"
    ]), this.appendChild(t), this.getAttribute("autofocus") !== null && this.input.focus();
  }
  buildInput() {
    const t = document.createElement("input");
    return t.classList.add(g, d), this.appendChild(t), t;
  }
  buildIcon() {
    const t = document.createElement("span"), l = this.getIconType(), i = s[l] || s[o];
    t.innerHTML = i, t.classList.add(v);
    const n = t.firstElementChild;
    return n == null || n.classList.add(m), t;
  }
  getIconType() {
    return this.getAttribute("disabled") !== null ? "disabled" : this.getAttribute("type") || o;
  }
}
const L = "sh-input";
a.define(L, f);
