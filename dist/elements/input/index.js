...
`;
var v = "sh-1d1c39w0", m = "sh-1d1c39w1", f = "sh-1d1c39w2", L = "sh-1d1c39w3";
const r = "text", a = {
  text: g,
  password: u,
  date: l,
  ...
  connectedCallback() {
    this.input = this.buildInput(), this.classList.add(v);
    const t = this.buildIcon();
    p(this.input, this, s.passingProps), this.appendChild(t), this.getAttribute("autofocus") !== null && this.input.focus();
  }
  buildInput() {
    const t = document.createElement("input");
    return t.classList.add(m, h), this.appendChild(t), t;
  }
  buildIcon() {
    const t = document.createElement("span"), o = this.getIconType(), n = a[o] || a[r];
    t.innerHTML = n, t.classList.add(f);
    const e = t.firstElementChild;
    return e == null || e.classList.add(L), t;
  }
  getIconType() {
    return this.getAttribute("disabled") !== null ? "disabled" : this.getAttribute("type") || r;
  }
  attributeChangedCallback(t, o, n) {
    this.input && s.passingProps.includes(t) && this.input.setAttribute(t, n);
  }
};
s.passingProps = [
  "placeholder",
  ...
  "name",
  "required"
], s.observedAttributes = s.passingProps;
let i = s;
const b = "sh-input";
d.define(b, i);
export {
