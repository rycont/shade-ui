import { D as r, p as d } from "./util-BfafNPJz.js";
import { s as a } from "./style.css-Cwz_uohT.js";
...
`;
var u = "sh-ui-1d1c39w0", w = "sh-ui-1d1c39w1", C = "sh-ui-1d1c39w2", g = "sh-ui-1d1c39w3";
const s = "text", o = {
  text: p,
  password: c,
  date: e,
...
class v extends HTMLElement {
  ...
  buildInput() {
    ...
    return t.classList.add(w, a), this.appendChild(t), t;
  }
  buildIcon() {
    const t = document.createElement("span"), i = this.getIconType(), l = o[i] || o[s];
    t.innerHTML = l, t.classList.add(C);
