...
import { s as H } from "./style.css-8cEf3HUX.js";
import "./theme.css.ts.vanilla-l0sNRNKZ.js";
const u = `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
var m = "sh-ui-1d1c39w0", L = "sh-ui-1d1c39w1", f = "sh-ui-1d1c39w2", M = "sh-ui-1d1c39w3";
const l = "text", r = {
  text: u,
  password: w,
  date: i,
...
class x extends HTMLElement {
  ...
  buildIcon() {
    const t = document.createElement("span"), d = this.getIconType(), a = r[d] || r[l];
